...
def main():
    ...
    try:
        ...
        try:
            ...
            textos_teste = ["Paciente apresenta febre alta e tosse seca" * 5 for _ in range(100)]
        ...
        resultado_sklearn = benchmark.benchmark_sklearn(textos=textos_teste, iteracoes=50)
        ...
        if os.path.exists(caminho_onnx):
            ...
            resultado_onnx = benchmark_onnx.benchmark_onnx(textos=textos_teste, iteracoes=50)
        ...
        if resultado_onnx:
            ...
            logger.info(
                f"  Razão de speedup: {resultado_sklearn['media_ms'] / resultado_onnx['media_ms']:.2f}x"
            )
        ...
        with open("data/models/benchmark_relatorio.json", "w") as f:
            ...
            relatorio_json = {}
            for backend, metricas in [
                ("sklearn", resultado_sklearn),
                ("onnx", resultado_onnx),
            ]:
                if metricas:
                    relatorio_json[backend] = {
